...
sns.lmplot(y='hp', x='weight', data=auto, row='origin')
# Display the plot
plt.show()



# visualizeing univariate distribution
...
# Extracting grayscale histogram from images
