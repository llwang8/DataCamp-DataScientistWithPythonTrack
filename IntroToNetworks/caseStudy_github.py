...
h.draw()
plt.show()
# Recall that in a MatrixPlot, nodes are the rows and columns of the matrix, and
...
c.draw()
plt.show()
# This CircosPlot provides a compact alternative to the ArcPlot. It is easy to see in this plot that
# most users belong to one group.
