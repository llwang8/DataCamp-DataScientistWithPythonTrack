...
# they have, and the second input is how many children they have. The model
# will predict how many transactions the user makes in the next year.
...
output = (hidden_layer_outputs * weights['outputs']).sum()
# Print output
print(output)
# -39
...
# last steps in classification model
# Import necessary modules
import keras
from keras.layers import Dense
from keras.models import Sequential
...
# Changing optimation parameters
...
# Building your own digit recognition model(MNIST dataset)
